package dm.smartjobs.jobseeker;
 ...
 */
@WebServlet("/JobSeekerDetails")
public class JobSeekerDetails extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			while (r.hasNext()) {
				...
				String jobseeker = name.toString();
				jname.add(jobseeker);
...
//		response.sendRedirect("CompanyDetails.jsp");
		RequestDispatcher rd = request.getRequestDispatcher("JobSeekerDetails.jsp");
